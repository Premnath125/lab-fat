pipeline {
    ...
    environment {
        DOCKER_IMAGE = "premnath0210/conference-app:latest"
    }

    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/Premnath125/lab-fat.git'
            }
        }
        ...
        stage('K8s Deployment') {
            steps {
                script {
                    ...
                    withCredentials([file(credentialsId: 'premnath0210', variable: 'KUBE_CFG')]) {
